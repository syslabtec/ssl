...
For online certificates, use Let's Encrypt instead ([tutorial]([https://gist.github.com/cecilemuller/a26737699a7e70a7093d4dc115915de8](https://github.com/syslabtec/ssl/blob/master/let's%20encrypt.md))).
